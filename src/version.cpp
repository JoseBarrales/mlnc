...
// for both lendcoind and lendcoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of lendcoin releases, the client name should be selected from
